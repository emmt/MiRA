...
* [YOIFITS](https://github.com/emmt/YOIFITS), [YLib](https://github.com/emmt/ylib) and
...
* Penalty with respect to data is now computed for Cartesian representation of a complex
  (not a polar).
