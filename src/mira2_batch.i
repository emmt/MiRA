...
_MIRA_CL_OPTS = _lst\
  ("\nData selection:",
   ...
   _lst("ftol", [], "REAL", OPT_REAL,
        "Function relative tolerance for the global convergence"),
   _lst("gtol", [], "REAL", OPT_REAL,
        "Gradient relative tolerance for the global convergence"),
   _lst("xtol", [], "REAL", OPT_REAL,
        "Variable relative tolerance for the global convergence"),
