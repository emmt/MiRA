...
_MIRA_OPTIONS = opt_init\
  ("Usage: mira2 [OPTIONS] INPUT [...] OUTPUT\n",
   ...
   (
    "\nData selection:",
    _lst("target", [], "NAME", OPT_STRING, "Name of the astrophysical object"),
    _lst("effwave", [], "LENGTH", OPT_STRING, "Effective wavelength, e.g. 1.6micron"),
    _lst("effband", [], "LENGTH", OPT_STRING, "Effective bandwidth, e.g. 200nm"),
    _lst("wavemin", [], "LENGTH", OPT_STRING, "Minimum wavelength, e.g. 1.5µm"),
    _lst("wavemax", [], "LENGTH", OPT_STRING, "Maximum wavelength, e.g. 1.7µm"),
    ...
    _lst("pixelsize", [], "ANGLE", OPT_STRING, "Angular size of pixels, e.g. 0.1mas"),
    _lst("fov", [], "ANGLE", OPT_STRING, "Angular size of the field of view, e.g. 20mas"),
    _lst("imagesize", [], "DIM|DIM1xDIM2", OPT_STRING, "Number of pixels per side of the image"),
    _lst("normalization", [], "VALUE", OPT_REAL, "Flux normalization (sum of pixels = VALUE)"),
    _lst("min", [], "LOWER", OPT_REAL, "Lower bound for the pixel values"),
    _lst("max", [], "UPPER", OPT_REAL, "Upper bound for the pixel values"),
    ...
    _lst("regul", [], "NAME", OPT_STRING, "Name of regularization method (use -regul=help for more information)"),
    ...
    _lst("gamma", [], "FWHM", OPT_STRING, "A priori full half width at half maximum, e.g. 15mas"),
 /*START OP 20180315 */ 
 ...
 /*END  OP 20180315 */
    ...
    _lst("seed", [], "VALUE", OPT_REAL, "Seed for the random generator"),
    "\nOutput image:",
    _lst("overwrite", [], [], OPT_FLAG, "Overwrite output if it exists"),
    _lst("bitpix", -32, "BITPIX", OPT_INTEGER, "Bits per pixel"),
    _lst("save_initial", [], [], OPT_FLAG, "Save initial image as a secondary HDU in the result"),
    "\nReconstruction strategy:",
    _lst("bootstrap", [], "COUNT", OPT_INTEGER, "Number of bootstrapping iterations"),
    _lst("recenter", [], [], OPT_FLAG, "Recenter result of bootstrapping iterations"),
    _lst("threshold", [], "FRACTION", OPT_REAL, "Level for soft-thresholding input image(s)"),
    "\nMessages:", //"\nMessages and graphics:",
    _lst("quiet", [], [], OPT_FLAG, "Suppress most messages"),
    _lst("verb", [], "COUNT", OPT_INTEGER, "Verbose level"),
    //_lst("view", 0, "MASK", OPT_INTEGER, "Bitwise mask to specify which graphics to show"),
    "\nOptimizer Settings:",
    _lst("mem", [], "COUNT", OPT_INTEGER, "Number of previous steps to memorize in VMLMB"),
    _lst("ftol", [], "REAL", OPT_REAL, "Function tolerance for the global convergence"),
    _lst("gtol", [], "REAL", OPT_REAL, "Gradient tolerance for the global convergence"),
    _lst("maxiter", [], "COUNT", OPT_INTEGER, "Maximum number of iterations"),
    _lst("maxeval", [], "COUNT", OPT_INTEGER, "Maximum number of evaluations of the objective function"),
    "\nLine search:",
    _lst("sftol", [], "REAL", OPT_REAL, "Function tolerance for the line search"),
    _lst("sgtol", [], "REAL", OPT_REAL, "Gradient tolerance for the line search"),
    _lst("sxtol", [], "REAL", OPT_REAL, "Step tolerance for the line search"),
    "\nMiscellaneous:",
    _lst("debug", [], [], OPT_FLAG, "Debug mode"),
    _lst("help", [], [], OPT_HELP, "Print out this help"),
    _lst("version", MIRA_VERSION, [], OPT_VERSION, "Print out version number")));
